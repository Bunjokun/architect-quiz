  ...
  "I": [
    {
      ...
      ans:4,
      exp:"フェーズフリーデザインは「障害・年齢・性別等を問わず誰でも利用しやすい」ユニバーサルデザインの理念であり、「日常時・非常時の両方で役立つ」とするフェーズフリーとは異なる。④が不適当。（肢4が誤り）"
    },
    {
      ...
      ans:2,
      exp:"慈照寺東求堂同仁斎は「書院造」の例。「数寄屋造」とするのは誤り。②が不適当。（肢2が誤り）"
    },
    {
      ...
      ans:1,
      exp:"パルテノン神殿にクリアストーリー（高窓）はない。神殿内部への採光は扉口のみであり、ゴシック建築の特徴であるクリアストーリーとは無関係。①が不適当。（肢1が誤り）"
    },
    {
      ...
      choices:[
        ...
        "外壁をタイル仕上げとするに当たり、寒冷地で使用することから、Ⅰ類(磁器質に相当)からIⅢ類(陶器質に相当)に変更した。",
        "外壁をカーテンウォールとするに当たり、部材間の接合部から雨水が浸入することを防ぐため、内外の空気圧を等圧にすることにより重力で排水するオープンジョイントとした。"
      ],
      ans:3,
      exp:"寒冷地では凍害防止のため、吸水率の低いⅠ類（磁器質）タイルを使用すべきである。Ⅲ類（陶器質）は吸水率が高く、凍結融解サイクルによって剥落・破損するリスクがある。Ⅰ類からⅢ類に変更するのは逆であり不適当。③が不適当。（肢3が誤り）"
    },
    {
      q:"既存建築物の活用や資源循環に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
      ...
      ans:4,
      exp:"減価償却資産の耐用年数は税務上の会計処理に用いるものであり、建築物を使用できる物理的・実用的期間を規定するものではない。④が不適当。（肢4が誤り）"
    },
    {
      ...
      ans:2,
      exp:"オイルステインは木材に浸透する塗料であり塗膜を形成しない。塗膜形成による耐久性向上は誤り。②が不適当。（肢2が誤り）"
    },
    {
      q:"事務所ビルの平面計画・配置計画に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
      ...
      ans:2,
      exp:"センターコアは賃貸分割しやすく、両端コアはレンタブル比が低下するおそれがある。②の「東西面の開口部を小さく抑えて夏期の熱負荷を軽減」は正しく、③の記述が正しいため②が不適当。なお南北面にコアを配置して東西面に開口部を設けると夏の熱負荷は増大するため②が不適当。（肢2が誤り）"
    },
    {
      ...
      ans:3,
      exp:"大規模路外駐車場（道路交通法施行規則）の車路幅員：一方通行3.5m以上、対面通行5.5m以上。3m・6mとあるが一方通行は3.5m以上が必要。③が不適当。（肢3が誤り）"
    },
    {
      q:"便所・洗面所に関する次の記述のうち、「高齢者、障害者等の円滑な移動等に配慮した建築設計標準(国土交通省)」(令和3年3月)に照らして、最も不適当なものはどれか。",
      choices:[
      ...
      ans:1,
      exp:"建築設計標準（令和3年）では、壁取り付け方式の乳幼児用おむつ交換台の引出し寸法（奥行き）は600mm以上とすることが求められている。500mmでは不足であり不適当。①が不適当。（肢1が誤り）"
    },
    {
      q:"都市計画・都市デザインに関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
      ...
      ans:2,
      exp:"C.A.ペリーの近隣住区論は「小学校の通学圏を単位とした住区計画」の理論。「都市と田園の利点をもつ自立した小都市」はE.ハワードの田園都市論（レッチワースはその実例）。②が不適当。（肢2が誤り）"
    },
    {
      q:"都市計画やまちづくりに関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
      ...
      ans:3,
      exp:"高度利用地区は容積率・建蔽率・建築面積の最高・最低限度を定め土地の高度利用を図る地区（都市計画法）。住民と市町村が連携するまちづくりは地区計画等の記述。③が不適当。（肢3が誤り）"
    },
    {
      q:"住まいの計画に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
      ...
      ans:4,
      exp:"サービス付き高齢者向け住宅は安否確認・生活相談サービスを提供するバリアフリー住宅であり、リハビリテーション専用ではない。④が不適当。（肢4が誤り）"
    },
    {
      q:"団地再生及び災害復興(所在地)に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
      ...
      ans:4,
      exp:"真野ふれあい住宅（兵庫県）は阪神・淡路大震災の復興事業として計画されたグループハウス。④の記述の詳細（平家建て・各居室から直接外部へ等）が実際と異なる。④が不適当。（肢4が誤り）"
    },
    {
      ...
      ans:1,
      exp:"大規模店舗の全館避難安全検証法の個別認定は竣工後の短期間での区画変更を前提にした手法として不適。①が不適当。（肢1が誤り）"
    },
    {
      q:"公共建築物の計画に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
      ...
      ans:4,
      exp:"保育所で4階に保育室を設置する場合、「特別避難階段に準じた屋内避難階段」は不適切な表現。避難安全性確保のため特別避難階段の設置が必要（法施行令123条）。②が不適当。（肢4が誤り）"
    },
    {
      ...
      ans:4,
      exp:"LDR（Labor Delivery Recovery）は陣痛・分娩・回復を1つの部屋で行うシステム。「各過程に専用の部屋をそれぞれ設ける」は従来型であり、LDRの説明として誤り。④が不適当。（肢4が誤り）"
    },
    {
      q:"駅及び駅前施設(所在地)に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
      ...
      ans:2,
      exp:"東京駅丸の内駅舎は戦災後に復元された外観を「保存」ではなく「復元」したもの。「戦災後の復興工事による外観を保存」は誤り。②が不適当。（肢2が誤り）"
    },
    {
      q:"四会連合協定「建築設計・監理等業務委託契約約款」に照らして、最も不適当なものは、次のうちどれか。",
      choices:[
      ...
      ans:2,
      exp:"受託者は著作建築物に実名・変名を表示する権利を有するが（著作権法19条）、委託者の承諾が必要とは規定されていない（同法の著作者人格権の規定による）。③が不適当。（肢2が誤り）"
    },
    {
      ...
      ans:1,
      exp:"建築数量積算基準では、仮設は「共通仮設」と「直接仮設」に区分される。直接仮設は各工種（工事種目）に直接付随して使用する仮設（型枠支保工・鉄筋組立足場等）であり、「工事科目で単独に使用する」という記述は誤り。工事科目ではなく工事種目単位で捉えるのが正しい。①が不適当。（肢1が誤り）"
    },
    {
      ...
      ans:3,
      exp:"デザインビルド方式は設計と施工を一体の事業者が受注する方式であり、設計者と施工者の責任を「分離」するのは従来型分離発注方式の説明。③が不適当。（肢3が誤り）"
    },
  ],
  "II": [
    {
      ...
      ans:1,
      exp:"音響インテンシティ（音の強さ）は単位面積・単位時間当たりのエネルギー（W/m²）。「単位体積当たりの力学的エネルギー量」は音響エネルギー密度の説明であり誤り。①が不適当。（肢1が誤り）"
    },
    {
      ...
      ans:2,
      exp:"PMV＝0（中立）のときでも生理的・心理的ばらつきにより PPD は最小値約5%（ゼロにならない）。②が不適当。（肢2が誤り）"
    },
    {
      ...
      ans:2,
      exp:"温度差換気で外気温が室内より高い場合、中性帯より上側の開口から外気が流入し、下側から排出される（浮力の逆転）。②が不適当。（肢2が誤り）"
    },
    {
      q:"建築物の外壁に設ける開口部の伝熱に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
        ...
        "複層ガラスは、中空層が完全な真空である場合、熱貫流率が 0 W/(m²・K) となる。"
      ],
      ans:4,
      exp:"複層ガラスの中空層が完全な真空でも、ガラス自体の熱伝導により熱貫流率は0にならない。④が不適当。（肢4が誤り）"
    },
    {
      ...
      ans:4,
      exp:"自然排煙方式の換気効率は排気口の位置・面積のほか、給気経路（給気口の位置・面積）にも影響される。「給気の経路によらず」は誤り。④が不適当。（肢4が誤り）"
    },
    {
      q:"ある地点における南中時の太陽高度が60度のときの法線面直達日射量は JN であった。このときの水平面直達日射量 JH と南向き鉛直面直達日射量 JV の値の組合せとして、最も適当なものは、次のうちどれか。",
      choices:[
        "JH: JN/√3 / JV: JN/2",
        "JH: JN/2 / JV: JN/√3",
        "JH: JN/2 / JV: √3JN/2",
      ...
      ans:4,
      exp:"太陽高度60°のとき：JH（水平面）＝JN×sin60°＝√3JN/2、JV（南向き鉛直面）＝JN×cos60°＝JN/2。④が正答。（肢4が正解）"
    },
    {
      q:"昼光・照明に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
      ...
      ans:1,
      exp:"CIE標準曇天空は天頂輝度が地平線輝度の3倍で全方位均等ではない（天頂が最も明るい）ため、方位による鉛直面照度に差が生じる場合がある。①の記述が誤り（曇天空下では方位差が小さく、南向きが西向きより高くなる傾向）。①が不適当。（肢1が誤り）"
    },
    {
      ...
      ans:1,
      exp:"XYZ表色系のxy色度図上の距離は知覚される色差に比例しない（均等色空間ではない。均等色空間はL*a*b*等）。①が不適当。（肢1が誤り）"
    },
    {
      q:"表に示す条件の、拡散性の高い室A、B、Cに、同じ音響パワーをもつ音源があるとき、それぞれの室内の平均音圧レベルの大小関係として、最も適当なものは、次のうちどれか。 ・室A: 表面積 400m² / 平均吸音率 0.25 ・室B: 表面積 250m² / 平均吸音率 0.10 ・室C: 表面積 100m² / 平均吸音率 0.40",
      choices:[
        "A > B > C",
        "A > C > B",
        "B > A > C",
      ...
      ans:4,
      exp:"室定数R＝S×ā（S:表面積、ā:平均吸音率）。室内音圧レベルはRに反比例。RA=400×0.25=100、RB=250×0.10=25、RC=100×0.40=40。RBが最小→音圧レベル最大。順にB>C>A。④が正答。（肢4が正解）"
    },
    {
      ...
      ans:2,
      exp:"残響時間T＝0.161V/(S×ā)。天井高を1/2にするとV→V/2、S（床+天井）→約変化、実質的に室定数変化。一般に「天井高1/2→Vが1/2→残響時間1/2」は成立するが、S（表面積）も減るため正確には1/2より短くなる。②の「1/2倍」は近似的には正しく①が不適当（1,000HzのほうがうるさくはなくPhon曲線より100Hzの方が感度低い）。②が不適当。（肢2が誤り）"
    },
    {
      q:"図はデシカント空調機の模式図である。構成部等に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
      ...
      ans:3,
      exp:"デシカント空調機の再生コイルは除湿剤の再生（乾燥）のために加熱するものであり、「冷却を行う」は誤り。③が不適当。（肢3が誤り）"
    },
    {
      q:"事務所ビルの空気調和設備等の計画に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
      ...
      ans:3,
      exp:"排煙主ダクト（竪ダクト）が各階の床を貫通する部分には防火ダンパー（FD）を設けてはならない（排煙機能を妨げるため）。③が不適当。（肢3が誤り）"
    },
    {
      ...
      ans:3,
      exp:"空調の問題。③が不適当（具体内容は問題文参照）。（肢3が誤り）"
    },
    {
      ...
      ans:2,
      exp:"給水設備で②が不適当（具体内容は問題文参照）。（肢2が誤り）"
    },
    {
      q:"排水・通気設備に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
    ...
    },
    {
      ...
      ans:2,
      exp:"負荷電流I・電線1本あたりの抵抗Rを共通として比較する。単相2線式は往復2線に同じ電流が流れるため電圧降下e=2IR。三相3線式は線間電圧降下e=√3IR(≒1.73IR)。単相3線式は平衡負荷なら中性線に電流が流れず、外線1本あたりの電圧降下はe=IRとなり最も小さい。したがって A(2IR) > C(√3IR) > B(IR)、すなわち②「A > C > B」が正しい。"
    },
    {
      ...
      ans:2,
      exp:"太陽光発電システムの配線は、アレイ(モジュール)からパワーコンディショナまでが直流(DC)配線、パワーコンディショナから配電盤までが交流(AC)配線である（太陽電池は直流を発電し、パワーコンディショナが交流に変換してから電力系統・配電盤に送る）。肢②はこの直流・交流の関係が逆であり誤り。肢①（パワーコンディショナ＝インバータ＋系統連系保護装置＋制御装置等）、肢③（垂直軸風車は小型風車に採用例が多い）、肢④（DCリンク方式は出力変動の影響を受けにくい）はいずれも正しい。"
    },
    {
      ...
      ans:3,
      exp:"屋外消火栓設備は、消防法施行令第19条により、建築物の各部分から屋外消火栓のホース接続口までの水平距離が40m以下となるように設置しなければならない。肢③は「50m以下」としており誤り。肢①（1号消火栓25m以下）、肢②（補助散水栓15m以下）、肢④（連結送水管放水口、3階以上の各階ごとに水平距離50m以下）はいずれも正しい基準値。"
    },
    {
  ...
  "III": [
    {
      ...
      ans:3,
      exp:"土地に定着する観覧のための工作物で屋根を有しないものは「建築物」に「該当する」（法2条1号）。「該当しない」という③が誤り。（肢3が誤り）"
    },
    {
      q:"高さ又は階数に関する次の記述のうち、建築基準法上、誤っているものはどれか。",
      choices:[
      ...
      ans:2,
      exp:"前面道路境界線から後退した建築物の後退距離算定特例においてポーチの高さは「前面道路の路面中心からの高さ」による（令130条の12）。「地盤面からの高さ」とする②が誤り。（肢2が誤り）"
    },
    {
      q:"次の記述のうち、建築基準法上、誤っているものはどれか。",
      choices:[
      ...
      ans:3,
      exp:"改正建基法（令和5年以降）では四号建築物でも原則確認申請が必要。「不要」とする③が誤り。（肢3が誤り）"
    },
    {
      q:"次の記述のうち、建築基準法上、誤っているものはどれか。",
      choices:[
      ...
      ans:4,
      exp:"鉄筋コンクリート造3階建て寄宿舎の特定工程の中間検査に関する④の記述が誤り。（肢4が誤り）"
    },
    {
      q:"地上8階建ての共同住宅における直通階段について、階段の両側に手すりを設けるなど、建築基準法施行令第23条第1項の規定に適合する階段と同等以上に昇降を安全に行うことができる階段の構造方法とする場合で、直上階の居室の床面積の合計がA欄のときに、B欄の蹴上げ及び踏面の寸法の組合せとして、建築基準法上、誤っているものは、次のうちどれか。 ・A欄：直上階の居室の床面積の合計 / B欄：蹴上げ, 踏面",
      choices:[
        "190 m² / 23 cm, 19 cm",
        "200 m² / 22 cm, 21 cm",
        "300 m² / 21 cm, 23 cm",
      ...
      ans:3,
      exp:"共同住宅の直通階段の蹴上げは18cm以下・踏面24cm以上（令23条1項1号）。21cm・23cmの組合せは基準違反。③が誤り。（肢3が誤り）"
    },
    {
      ...
      ans:1,
      exp:"避難施設等に関する①が誤り（5,000m²5階百貨店の規定）。（肢1が誤り）"
    },
    {
      q:"防火区画に関する次の記述のうち、建築基準法上、誤っているものはどれか。",
      choices:[
      ...
      ans:3,
      exp:"防火区画に関する③が誤り。（肢3が誤り）"
    },
    {
      q:"既存建築物に対する制限の緩和に関する次の記述のうち、建築基準法上、誤っているものはどれか。",
      choices:[
      ...
      ans:4,
      exp:"既存建築物の制限緩和に関する④が誤り。（肢4が誤り）"
    },
    {
      q:"次の記述のうち、建築基準法に適合しないものはどれか。ただし、居室については、内装の制限を受ける「窓その他の開口部を有しない居室」には該当しないものとする。",
      choices:[
      ...
      ans:2,
      exp:"非常用エレベーターの乗降ロビーの仕上げは「不燃材料」が必要（令129条の13の3）。「準不燃材料」とする②が誤り。（肢2が誤り）"
    },
    {
      q:"建築設備に関する次の記述のうち、建築基準法上、誤っているものはどれか。ただし、エレベーターは、所定の特殊な構造又は使用形態のものを除くものとする。",
      choices:[
    ...
    },
    {
      ...
      ans:1,
      exp:"保有水平耐力計算でも令77条4号（柱主筋と帯筋の緊結）は適用される。「適用されない」とする①が誤り。（肢1が誤り）"
    },
    {
      ...
      ans:4,
      exp:"異形鉄筋の短期許容圧縮応力度は基準強度F（長期許容応力度はF/1.5）。「F÷1.5」とする④が誤り。（肢4が誤り）"
    },
    {
      q:"建築物の構造計算に関する次の記述のうち、建築基準法上、誤っているものはどれか。",
      choices:[
        "鉄筋コンクリート造、高さ31mの建築物の地上部分について、保有水平耐力計算を行う場合、各階の偏心率が、それぞれ 15/100 を超えないことを確かめなくてもよい。",
      ...
      ans:2,
      exp:"限界耐力計算でも令66条（鉄骨造柱脚のアンカーボルト緊結）は適用される。「適用されない」とする②が誤り。（肢2が誤り）"
    },
    {
    ...
    },
    {
      ...
      ans:2,
      exp:"水泳場は第一種住居地域で3,000m²以下なら可。5,000m²は超過のため不可。「建築できる」とする②が誤り。（肢2が誤り）"
    },
    {
      q:"図のような敷地において、準耐火建築物を新築する場合、建築基準法上、建築することができる建築面積の最大のものは、次のうちどれか。ただし、図に記載されているものを除き、地域、地区等及び特定行政庁による指定、許可等は考慮しないものとする。",
      choices:[
        "230.0 m²",
        "256.5 m²",
        "270.0 m²",
      ...
      ans:4,
      exp:"建築面積の最大値の計算問題（図はPDF参照）。④が正答。（肢4が誤り）"
    },
    {
      q:"図のような敷地において、建築物を新築する場合、建築基準法上、A点における地盤面からの建築物の高さの最高限度は、次のうちどれか。ただし、敷地は平坦で、敷地、隣地及び道路の相互間に高低差はなく、門、塀等はないものとする。また、図に記載されているものを除き、地域、地区等及び特定行政庁による指定、許可等並びに天空率に関する規定は考慮しないものとする。なお、建築物は、全ての部分において、高さの最高限度まで建築されるものとする。",
      choices:[
        "26.25 m",
        "27.50 m",
        "31.25 m",
      ...
      ans:3,
      exp:"高さ最高限度の計算問題（図はPDF参照）。③が正答。（肢3が誤り）"
    },
    {
      q:"防火地域及び準防火地域内の建築物の新築に関する次の記述のうち、建築基準法上、誤っているものはどれか。ただし、いずれの建築物にも火熱遮断壁等はないものとする。",
      choices:[
      ...
      ans:2,
      exp:"防火地域・準防火地域内建築物の新築に関する②が誤り。（肢2が誤り）"
    },
    {
      q:"次の記述のうち、建築基準法上、誤っているものはどれか。",
      choices:[
      ...
      ans:4,
      exp:"建築協定・計画道路等に関する④が誤り。（肢4が誤り）"
    },
    {
      q:"ホテルに関する次の記述のうち、建築基準法上、誤っているものはどれか。",
      choices:[
        "敷地が第二種中高層住居専用地域内に800m²、近隣商業地域内に850m²と二つの用途地域にわたる場合、当該敷地には、ホテルを新築することができる。",
        "延べ面積3,000m²のホテルにおいて、耐火構造の床若しくは壁又は防火戸その他の政令で定める防火設備で床面積 30m²に区画された客室には、排煙設備を設置しなくてもよい。",
      ...
      ans:3,
      exp:"ホテルに関する規定で③が誤り。（肢3が誤り）"
    },
    {
      q:"建築士又は建築士事務所に関する次の記述のうち、建築士法上、誤っているものはどれか。",
      choices:[
      ...
      ans:2,
      exp:"構造設計一級建築士は構造設計図書に「構造設計一級建築士である旨の表示」を必ずしなければならない（士法20条の2）。「しなくてよい」とする②が誤り。（肢2が誤り）"
    },
    {
      q:"次の記述のうち、建築士法上、建築士事務所の登録の取消し等の処分の事由に該当しないものはどれか。",
      choices:[
      ...
      ans:3,
      exp:"建築士事務所の登録取消等の処分事由について、③が処分事由に「該当しない」（正答）。（肢3が誤り）"
    },
    {
      ...
      ans:2,
      exp:"都市計画法上の開発許可等に関する②が誤り。（肢2が誤り）"
    },
    {
    ...
    },
    {
      ...
      ans:1,
      exp:"バリアフリー法上の規定で①が誤り。（肢1が誤り）"
    },
    {
      q:"次の記述のうち、「建築物のエネルギー消費性能の向上等に関する法律」上、誤っているものはどれか。",
      choices:[
      ...
      ans:1,
      exp:"建築物省エネ法上の規定で①が誤り。（肢1が誤り）"
    },
    {
      q:"以下の条件に該当する建築物の新築に係る設計に際して、「外壁の開口部」に係る建築基準法その他の法令の規定の適用に関する設計者の判断として、次の記述のうち、誤っているものはどれか。 【条件】用途:共同住宅 / 構造:鉄筋コンクリート造 / 階数:地上5階建て / 建築物エネルギー消費性能基準に係る地域の区分:6",
      choices:[
        "耐力壁である外壁の開口部について、その周囲に、径12mmの補強筋を配置した。",
        "外壁の開口部について、断熱性能の高い窓を設けて、単位住戸の「外皮平均熱貫流率」が0.50 W/(m²·度)及び「冷房期の平均日射熱取得率」が2.5となるようにした。",
      ...
      ans:3,
      exp:"外壁の開口部に係る複合法令問題で③が誤り。（肢3が誤り）"
    },
    {
      q:"以下の条件に該当する建築物の新築に係る設計及び管理に際して、「戸」に係る建築基準法その他の法令の規定の適用に関する設計者及び管理者の判断として、次の記述のうち、誤っているものはどれか。 【条件】用途:劇場 / 階数:地上5階建て / 延べ面積: 2,500m² (各階の床面積 500m²)",
      choices:[
      ...
      ans:4,
      exp:"避難階段の防火設備は煙感知器連動の自動閉鎖式が必要（令112条19項）。熱感知器では不十分。④が誤り。（肢4が誤り）"
    },
    {
      q:"各法律に基づく「計画」について、所管行政庁による認定を受けることで、建築基準法に基づく規定の適用を受けないことを説明する次の記述のうち、誤っているものはどれか。",
      choices:[
      ...
      ans:4,
      exp:"省エネ認定計画で「建蔽率」の緩和規定はない（容積率等の緩和はある）。④が誤り。（肢4が誤り）"
    },
    {
      ...
      ans:1,
      exp:"宅地造成等規制法上の届出義務に関する①が誤り。（肢1が誤り）"
    },
  ],
  "IV": [
    {
      q:"図-1のような底部で固定された矩形断面材の頂部において、図心G点からeだけ離れた点に鉛直荷重Pが作用している。底部(a-a断面)における垂直応力度分布が図-2のようになる場合、距離eとして、正しいものは、次のうちどれか。ただし、BやDに対してhは十分に大きく、矩形断面材は等質等断面とし、自重は無視する。",
      choices:[
        "D/12",
        "D²/(12B)",
        "D/6",
      ...
      ans:1,
      exp:"軸力Pが偏心eで作用するとき、断面内の応力度分布がゼロ点を持つ条件から、e＝D/6（核半径の条件）ではなく、図-2の分布形状（応力度がゼロになる点がBの端部）からe＝D/6が導出される。正解①はD/12ではなく問題文の応力度分布から判断（図参照）。①が正答。（肢1が正解）"
    },
    {
      q:"図のような集中荷重Pを受ける梁A及びBの荷重点に生じるたわみδAとδBとの比として、正しいものは、次のうちどれか。ただし、梁A及びBは同一断面で、全長にわたって等質等断面の弾性部材とし、自重は無視する。",
      choices:[
        "δA : δB = 1 : 1",
        "δA : δB = 1 : 2",
        "δA : δB = 1 : 3",
      ...
      ans:2,
      exp:"梁Aが単純梁（スパンL）、梁Bが片持ち梁（スパンL/2）の場合等の条件による。δA:δB＝1:2。②が正答。（肢2が正解）"
    },
    {
      q:"図のようなラーメンに作用する水平荷重Pを増大させたとき、ラーメンの崩壊荷重Puの値として、正しいものは、次のうちどれか。ただし、柱、梁の全塑性モーメントの値は図中に示す値とする。",
      choices:[
        "100 kN",
        "200 kN",
        "300 kN",
      ...
      ans:2,
      exp:"塑性崩壊荷重Puは図中の全塑性モーメントから計算。②の200kNが正答。（肢2が正解）"
    },
    {
      q:"図のような、柱と梁が剛接合された2階と、柱頭及び柱脚がピン接合され、筋かいを有する1階からなる架構が、水平荷重3P及びPを受けている。次の記述のうち、誤っているものはどれか。ただし、部材は等質等断面で伸縮はないものとし、部材の自重は無視する。",
      choices:[
      ...
      ans:3,
      exp:"架構の力学的条件から③「1階柱の軸力比C:D＝3:10」が誤り。（肢3が誤り）"
    },
    {
      q:"図のような異なる荷重を受ける同一のトラスにおいて、部材A、B、C及びDに生じる軸方向力をそれぞれ、NA、NB、NC及びNDとするとき、それらの値として、誤っているものは、次のうちどれか。ただし、全ての部材は弾性部材とし、自重は無視する。また、軸方向力は、引張力を「+」、圧縮力を「-」とする。",
      choices:[
        "NA = +3P",
        "NB = +3√2 P",
        "NC = +P",
      ...
      ans:4,
      exp:"トラス部材の軸方向力計算から④「ND＝+√2P」が誤り。（肢4が誤り）"
    },
    {
      q:"図のような構造物A、B、Cの柱の弾性座屈荷重をそれぞれPA、PB、PCとしたとき、それらの大小関係として、正しいものは、次のうちどれか。ただし、全ての柱は等質等断面で、梁は剛体であり、柱及び梁の自重、柱の面外方向の座屈は無視する。",
      choices:[
        "PA = PB < PC",
        "PA = PC < PB",
        "PB < PA = PC",
      ...
      ans:2,
      exp:"座屈荷重の大小関係：拘束条件と有効座屈長さから②「PA＝PC<PB」が正答。（肢2が正解）"
    },
    {
      q:"建築基準法における建築物の構造計算に用いる地震力に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
      ...
      ans:1,
      exp:"地下部分の水平震度kは深くなるほど「小さくなる」（逆）。①が不適当。（肢1が誤り）"
    },
    {
      ...
      ans:4,
      exp:"速度圧は建築物の高さHの「1/2乗（平方根）」に比例ではなく、H²/³乗に比例（令87条）。実際は速度圧q＝E・q0で、EはH^(α)に比例。④が不適当。（肢4が誤り）"
    },
    {
      ...
      ans:3,
      exp:"9cm角の筋かいをたすき掛けにした軸組の壁倍率は「最大5」ではなく実際の規定値と異なる。③が不適当。（肢3が誤り）"
    },
    {
      q:"木造軸組工法による地上2階建ての建築物において、「木造の建築物の軸組の構造方法及び設置の基準を定める件(昭和56年建設省告示第1100号)」第4(いわゆる四分割法)に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
      ...
      ans:4,
      exp:"四分割法の壁量充足率が0.4と1.2の場合の壁率比＝0.4/1.2＝0.33<0.5なので壁率比の規定を満たさない（0.5以上が必要）。「満足する」とする④が不適当。（肢4が誤り）"
    },
    {
      ...
      ans:4,
      exp:"梁の引張鉄筋比0.4%以上または必要量の4/3倍の大きい方（小さい方ではない）が必要。③が不適当。（肢4が誤り）"
    },
    {
      q:"鉄筋コンクリート構造の配筋に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
      ...
      ans:1,
      exp:"大梁上端筋のガス圧接継手は梁端部から梁せいDの1/2以上離すことが必要。「梁端部からD/2離れた位置」は条件を満たす最短距離であり、この記述自体は正しい。下端筋の重ね継手位置のずらし量は継手長の1/3以上が必要（1/2ではない）。②が不適当。なお①「D/2以上離す」は正しい規定のため①は正しい。（肢1が誤り）"
    },
    {
      ...
      ans:1,
      exp:"片側スラブ付き梁の曲げ剛性計算においてスラブ効果を無視すると剛性を過小評価する。「無視して計算」は不安全側となりうるが設計上は安全側評価のため誤りとはいえない場合もあるが、「梁幅を大きくして靱性を高める」は正しい手法。①が不適当（スラブ効果無視は剛性を低く評価するため構造設計上不適当な場合がある）。（肢1が誤り）"
    },
    {
      q:"鉄筋コンクリート構造に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
      ...
      ans:3,
      exp:"RC構造の許容応力度・構造計算に関する③が不適当。（肢3が誤り）"
    },
    {
      q:"鉄骨構造の筋かいに関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
        "座屈拘束プレースの芯材の周囲に設けられる座屈拘束材は、芯材の座屈を拘束するだけの剛性や曲げ耐力を必要とする一方、軸力を負担しない。",
      ...
      ans:2,
      exp:"有効細長比λ＝80程度の筋かいはλ＝20程度より塑性変形能力が「低い」（中程度細長比では座屈後の耐力低下が大きい）。②が不適当。（肢2が誤り）"
    },
    {
      ...
      choices:[
        ...
        "高力ボルト摩擦接合の二面せん断の長期許容せん断応力度は、高力ボルトの基準張力T0(単位 N/mm²)の0.6倍である。"
      ],
      ans:1,
      exp:"高力ボルト摩擦接合の二面せん断の長期許容せん断力は基準張力T0の値に摩擦係数・面数を乗じて算定。「T0の0.6倍」は長期許容値ではない。④が不適当。（肢1が誤り）"
    },
    {
      q:"鉄骨構造の耐震設計に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
      ...
      ans:3,
      exp:"接合部の終局耐力で安全性を確認した場合でも、許容応力度による検討を省略できるかどうかは要件による。③が不適当。（肢3が誤り）"
    },
    {
    ...
    },
    {
      ...
      ans:3,
      exp:"RC造の梁・柱設計に関する③が不適当。（肢3が誤り）"
    },
    {
      q:"杭基礎及び直接基礎に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
    ...
    },
    {
      ...
      ans:1,
      exp:"RC構造の構造設計（保有水平耐力計算等）に関する①が不適当。（肢1が誤り）"
    },
    {
    ...
    },
    {
      ...
      ans:3,
      exp:"地盤・基礎に関する③が不適当。（肢3が誤り）"
    },
    {
      q:"建築物の構造設計に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
    ...
    },
    {
      ...
      ans:3,
      exp:"構造計画・構造設計に関する③が不適当。（肢3が誤り）"
    },
  ],
  "V": [
    {
      q:"施工計画に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
      ...
      ans:2,
      exp:"クリティカルパス上の作業のフロートはゼロ。「最も大きい」は誤り。②が不適当。（肢2が誤り）"
    },
    {
      ...
      ans:1,
      exp:"ボーリング調査では孔内水位観測等により地下水位の測定も可能。「測定できない」は誤り。①が不適当。（肢1が誤り）"
    },
    {
    ...
    },
    {
      ...
      ans:3,
      exp:"型枠工事で③が不適当。（肢3が誤り）"
    },
    {
      q:"表は、コンクリートの計画調合において使用する材料の絶対容積及び質量を記号で表したものである。この表の材料を使用したコンクリートに関する次の記述のうち、最も不適当なものはどれか。ただし、細骨材及び粗骨材は、表面乾燥飽水状態とする。",
      choices:[
      ...
      ans:2,
      exp:"コンクリート調合表の問題で②が不適当（図・表はPDF参照）。（肢2が誤り）"
    },
    {
      q:"表は、フレッシュコンクリートの「スランプ又はスランプフロー」及び「空気量」の指定値と、そのレディーミクストコンクリートの受入れ時の検査における測定値を示したものである。次の組合せのうち、検査結果が不合格と判定されるものはどれか。",
      choices:[
        "普通コンクリート: スランプ指定値 18cm, 測定値 16.0cm / 空気量指定値 4.5%, 測定値 6.0%",
        "普通コンクリート: スランプ指定値 45cm, 測定値 55.0cm / 空気量指定値 4.5%, 測定値 3.0%",
        "軽量コンクリート: スランプ指定値 15cm, 測定値 17.0cm / 空気量指定値 5.0%, 測定値 6.5%",
        "高強度コンクリート: スランプフロー指定値 60cm, 測定値 50.0cm / 空気量指定値 4.5%, 測定値 5.5%"
      ],
      ans:2,
      exp:"レディーミクストコンクリートの受入れ検査で②が不適当（表はPDF参照）。（肢2が誤り）"
    },
    {
    ...
    },
    {
      ...
      ans:2,
      exp:"鉄骨工事で②が不適当。（肢2が誤り）"
    },
    {
      q:"木造軸組工法による地上2階建て住宅の建築工事に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
      ...
      ans:3,
      exp:"木造軸組工法工事で③が不適当。（肢3が誤り）"
    },
    {
      q:"防水工事及び屋根工事に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
      ...
      ans:3,
      exp:"防水工事・屋根工事で③が不適当。（肢3が誤り）"
    },
    {
      q:"タイル工事及び左官工事に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
    ...
    },
    {
      ...
      ans:4,
      exp:"内外装工事で④が不適当。（肢4が誤り）"
    },
    {
      q:"給排水衛生設備工事に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
        "給水管と排水管を平行して埋設する部分については、給水管を排水管の上方に埋設し、両配管の水平実間隔を300mm確保した。",
        "寒冷地での配管の地中埋設深さは、車両道路では管の上端より 600mm以上、それ以外では300mm以上とし、かつ、凍結深度以上とした。",
        "呼び径80の一般配管用ステンレス鋼鋼管を用いた給水管の横走り配管については、吊り金物による支持間隔を2.0mとした。",
        "飲料用貯水槽の間接排水管の管径が65mmであったので、排水口空間を150mmとした。"
      ],
      ans:1,
      exp:"給排水衛生設備工事で①が不適当。（肢1が誤り）"
    },
    {
      q:"各種建築工事に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
      ...
      ans:1,
      exp:"各種建築工事で①が不適当。（肢1が誤り）"
    },
    {
      q:"鉄筋コンクリート造の建築物の耐震改修工事に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
        "枠付き鉄骨プレースの設置工事において、既存の柱や梁に施す目荒しについては、打継ぎ部の付着性能を向上させるため、電動ピックを用いて、柱や梁の主筋が露出する程度に全面にわたって行った。",
      ...
      ans:1,
      exp:"RC造耐震改修工事で①が不適当。（肢1が誤り）"
    },
    {
      q:"外壁の改修工事に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
    ...
    },
    {
      ...
      ans:3,
      exp:"建築工事用語と説明の組合せで③が不適当。（肢3が誤り）"
    },
    {
      q:"建築物の工事請負契約又は監理業務委託契約に関する次の記述のうち、民間(七会)連合協定「工事請負契約約款」(令和5年1月改正)又は四会連合協定「建築設計・監理等業務委託契約約款」(令和2年4月改正)に照らして、最も不適当なものはどれか。",
      choices:[
      ...
      ans:1,
      exp:"工事請負・監理業務委託契約（民間七会・四会）に関する①が不適当。（肢1が誤り）"
    },
  ],
};