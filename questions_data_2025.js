window.QUESTION_DATA_2025 = {
  "I": [
    ...
    },
    {
      ...
      ans:3,
      exp:"ウェイファインディング・デザインは空間内の経路誘導・案内サインのデザインであり、備品・什器の直感的操作性（アフォーダンス）とは別概念。③が不適当。（肢3が誤り）"
    },
    {
    ...
    },
    {
      ...
      ans:1,
      exp:"操作部の位置：呼出しボタンは洗浄ボタンと同じ高さで後方200mm離れた位置は正しくない。呼出しボタンの位置規定と洗浄ボタンの関係が誤り。③が不適当。（肢1が誤り）"
    },
    {
    ...
    },
    {
      ...
      ans:1,
      exp:"仮設における直接仮設は各工種で「単独に使用する」仮設。「工事種目ごとに共通して使用する」共通仮設と区別される。①が不適当。（肢1が誤り）"
    },
    {
