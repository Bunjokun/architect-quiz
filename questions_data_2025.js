  ...
  "I": [
    {
      ...
      ans:4,
      exp:"フェーズフリーデザインは「障害・年齢・性別等を問わず誰でも利用しやすい」ユニバーサルデザインの理念であり、「日常時・非常時の両方で役立つ」とするフェーズフリーとは異なる。④が不適当。"
    },
    {
      ...
      ans:2,
      exp:"慈照寺東求堂同仁斎は「書院造」の例。「数寄屋造」とするのは誤り。②が不適当。"
    },
    {
      ...
      ans:1,
      exp:"パルテノン神殿にクリアストーリー（高窓）はない。神殿内部への採光は扉口のみであり、ゴシック建築の特徴であるクリアストーリーとは無関係。①が不適当。"
    },
    {
      ...
      ans:3,
      exp:"ウェイファインディング・デザインは空間内の経路誘導・案内サインのデザインであり、備品・什器の直感的操作性（アフォーダンス）とは別概念。③が不適当。"
    },
    {
      ...
      ans:4,
      exp:"減価償却資産の耐用年数は税務上の会計処理に用いるものであり、建築物を使用できる物理的・実用的期間を規定するものではない。④が不適当。"
    },
    {
      ...
      ans:2,
      exp:"オイルステインは木材に浸透する塗料であり塗膜を形成しない。塗膜形成による耐久性向上は誤り。②が不適当。"
    },
    {
      ...
      ans:2,
      exp:"センターコアは賃貸分割しやすく、両端コアはレンタブル比が低下するおそれがある。②の「東西面の開口部を小さく抑えて夏期の熱負荷を軽減」は正しく、③の記述が正しいため②が不適当。なお南北面にコアを配置して東西面に開口部を設けると夏の熱負荷は増大するため②が不適当。"
    },
    {
      ...
      ans:3,
      exp:"大規模路外駐車場（道路交通法施行規則）の車路幅員：一方通行3.5m以上、対面通行5.5m以上。3m・6mとあるが一方通行は3.5m以上が必要。③が不適当。"
    },
    {
      ...
      ans:1,
      exp:"操作部の位置：呼出しボタンは洗浄ボタンと同じ高さで後方200mm離れた位置は正しくない。呼出しボタンの位置規定と洗浄ボタンの関係が誤り。③が不適当。"
    },
    {
      ...
      ans:2,
      exp:"C.A.ペリーの近隣住区論は「小学校の通学圏を単位とした住区計画」の理論。「都市と田園の利点をもつ自立した小都市」はE.ハワードの田園都市論（レッチワースはその実例）。②が不適当。"
    },
    {
      ...
      ans:3,
      exp:"高度利用地区は容積率・建蔽率・建築面積の最高・最低限度を定め土地の高度利用を図る地区（都市計画法）。住民と市町村が連携するまちづくりは地区計画等の記述。③が不適当。"
    },
    {
      ...
      ans:4,
      exp:"サービス付き高齢者向け住宅は安否確認・生活相談サービスを提供するバリアフリー住宅であり、リハビリテーション専用ではない。④が不適当。"
    },
    {
      ...
      ans:4,
      exp:"真野ふれあい住宅（兵庫県）は阪神・淡路大震災の復興事業として計画されたグループハウス。④の記述の詳細（平家建て・各居室から直接外部へ等）が実際と異なる。④が不適当。"
    },
    {
      ...
      ans:1,
      exp:"大規模店舗の全館避難安全検証法の個別認定は竣工後の短期間での区画変更を前提にした手法として不適。①が不適当。"
    },
    {
      ...
      ans:4,
      exp:"保育所で4階に保育室を設置する場合、「特別避難階段に準じた屋内避難階段」は不適切な表現。避難安全性確保のため特別避難階段の設置が必要（法施行令123条）。②が不適当。"
    },
    {
      ...
      ans:4,
      exp:"LDR（Labor Delivery Recovery）は陣痛・分娩・回復を1つの部屋で行うシステム。「各過程に専用の部屋をそれぞれ設ける」は従来型であり、LDRの説明として誤り。④が不適当。"
    },
    {
      ...
      ans:2,
      exp:"東京駅丸の内駅舎は戦災後に復元された外観を「保存」ではなく「復元」したもの。「戦災後の復興工事による外観を保存」は誤り。②が不適当。"
    },
    {
      ...
      ans:2,
      exp:"受託者は著作建築物に実名・変名を表示する権利を有するが（著作権法19条）、委託者の承諾が必要とは規定されていない（同法の著作者人格権の規定による）。③が不適当。"
    },
    {
      ...
      ans:1,
      exp:"仮設における直接仮設は各工種で「単独に使用する」仮設。「工事種目ごとに共通して使用する」共通仮設と区別される。①が不適当。"
    },
    {
      ...
      ans:3,
      exp:"デザインビルド方式は設計と施工を一体の事業者が受注する方式であり、設計者と施工者の責任を「分離」するのは従来型分離発注方式の説明。③が不適当。"
    },
  ],
  "II": [
    {
      ...
      ans:1,
      exp:"音響インテンシティ（音の強さ）は単位面積・単位時間当たりのエネルギー（W/m²）。「単位体積当たりの力学的エネルギー量」は音響エネルギー密度の説明であり誤り。①が不適当。"
    },
    {
      ...
      ans:2,
      exp:"PMV＝0（中立）のときでも生理的・心理的ばらつきにより PPD は最小値約5%（ゼロにならない）。②が不適当。"
    },
    {
      ...
      ans:2,
      exp:"温度差換気で外気温が室内より高い場合、中性帯より上側の開口から外気が流入し、下側から排出される（浮力の逆転）。②が不適当。"
    },
    {
      ...
      ans:4,
      exp:"複層ガラスの中空層が完全な真空でも、ガラス自体の熱伝導により熱貫流率は0にならない。④が不適当。"
    },
    {
      ...
      ans:4,
      exp:"自然排煙方式の換気効率は排気口の位置・面積のほか、給気経路（給気口の位置・面積）にも影響される。「給気の経路によらず」は誤り。④が不適当。"
    },
    {
      ...
      ans:4,
      exp:"太陽高度60°のとき：JH（水平面）＝JN×sin60°＝√3JN/2、JV（南向き鉛直面）＝JN×cos60°＝JN/2。④が正答。"
    },
    {
      ...
      ans:1,
      exp:"CIE標準曇天空は天頂輝度が地平線輝度の3倍で全方位均等ではない（天頂が最も明るい）ため、方位による鉛直面照度に差が生じる場合がある。①の記述が誤り（曇天空下では方位差が小さく、南向きが西向きより高くなる傾向）。①が不適当。"
    },
    {
      ...
      ans:1,
      exp:"XYZ表色系のxy色度図上の距離は知覚される色差に比例しない（均等色空間ではない。均等色空間はL*a*b*等）。①が不適当。"
    },
    {
      ...
      ans:4,
      exp:"室定数R＝S×ā（S:表面積、ā:平均吸音率）。室内音圧レベルはRに反比例。RA=400×0.25=100、RB=250×0.10=25、RC=100×0.40=40。RBが最小→音圧レベル最大。順にB>C>A。④が正答。"
    },
    {
      ...
      ans:2,
      exp:"残響時間T＝0.161V/(S×ā)。天井高を1/2にするとV→V/2、S（床+天井）→約変化、実質的に室定数変化。一般に「天井高1/2→Vが1/2→残響時間1/2」は成立するが、S（表面積）も減るため正確には1/2より短くなる。②の「1/2倍」は近似的には正しく①が不適当（1,000HzのほうがうるさくはなくPhon曲線より100Hzの方が感度低い）。②が不適当。"
    },
    {
      ...
      ans:3,
      exp:"デシカント空調機の再生コイルは除湿剤の再生（乾燥）のために加熱するものであり、「冷却を行う」は誤り。③が不適当。"
    },
    {
      ...
      ans:3,
      exp:"排煙主ダクト（竪ダクト）が各階の床を貫通する部分には防火ダンパー（FD）を設けてはならない（排煙機能を妨げるため）。③が不適当。"
    },
    {
    ...
    },
    {
      ...
      ans:2,
      exp:"電圧降下は単相2線式が最大。3線式（単相・三相）は2線式と比較して電圧降下が小さい。②が正答。"
    },
    {
  ...
  "III": [
    {
      ...
      ans:3,
      exp:"土地に定着する観覧のための工作物で屋根を有しないものは「建築物」に「該当する」（法2条1号）。「該当しない」という③が誤り。"
    },
    {
      ...
      ans:2,
      exp:"前面道路境界線から後退した建築物の後退距離算定特例においてポーチの高さは「前面道路の路面中心からの高さ」による（令130条の12）。「地盤面からの高さ」とする②が誤り。"
    },
    {
      q:"次の記述のうち、建築基準法上、誤っているものはどれか。",
      choices:[
      ...
      ans:3,
      exp:"改正建基法（令和5年以降）では四号建築物でも原則確認申請が必要。「不要」とする③が誤り。"
    },
    {
      q:"次の記述のうち、建築基準法上、誤っているものはどれか。",
      choices:[
      ...
      ans:4,
      exp:"鉄筋コンクリート造3階建て寄宿舎の特定工程の中間検査に関する④の記述が誤り。"
    },
    {
      ...
      ans:3,
      exp:"共同住宅の直通階段の蹴上げは18cm以下・踏面24cm以上（令23条1項1号）。21cm・23cmの組合せは基準違反。③が誤り。"
    },
    {
      ...
      ans:1,
      exp:"避難施設等に関する①が誤り（5,000m²5階百貨店の規定）。"
    },
    {
    ...
    },
    {
      ...
      ans:2,
      exp:"非常用エレベーターの乗降ロビーの仕上げは「不燃材料」が必要（令129条の13の3）。「準不燃材料」とする②が誤り。"
    },
    {
    ...
    },
    {
      ...
      ans:1,
      exp:"保有水平耐力計算でも令77条4号（柱主筋と帯筋の緊結）は適用される。「適用されない」とする①が誤り。"
    },
    {
      ...
      ans:4,
      exp:"異形鉄筋の短期許容圧縮応力度は基準強度F（長期許容応力度はF/1.5）。「F÷1.5」とする④が誤り。"
    },
    {
      ...
      ans:2,
      exp:"限界耐力計算でも令66条（鉄骨造柱脚のアンカーボルト緊結）は適用される。「適用されない」とする②が誤り。"
    },
    {
    ...
    },
    {
      ...
      ans:2,
      exp:"水泳場は第一種住居地域で3,000m²以下なら可。5,000m²は超過のため不可。「建築できる」とする②が誤り。"
    },
    {
    ...
    },
    {
      ...
      ans:2,
      exp:"構造設計一級建築士は構造設計図書に「構造設計一級建築士である旨の表示」を必ずしなければならない（士法20条の2）。「しなくてよい」とする②が誤り。"
    },
    {
      ...
      ans:3,
      exp:"建築士事務所の登録取消等の処分事由について、③が処分事由に「該当しない」（正答）。"
    },
    {
    ...
    },
    {
      ...
      ans:4,
      exp:"避難階段の防火設備は煙感知器連動の自動閉鎖式が必要（令112条19項）。熱感知器では不十分。④が誤り。"
    },
    {
      ...
      ans:4,
      exp:"省エネ認定計画で「建蔽率」の緩和規定はない（容積率等の緩和はある）。④が誤り。"
    },
    {
  ...
  "IV": [
    {
      ...
      ans:1,
      exp:"軸力Pが偏心eで作用するとき、断面内の応力度分布がゼロ点を持つ条件から、e＝D/6（核半径の条件）ではなく、図-2の分布形状（応力度がゼロになる点がBの端部）からe＝D/6が導出される。正解①はD/12ではなく問題文の応力度分布から判断（図参照）。①が正答。"
    },
    {
      ...
      ans:2,
      exp:"梁Aが単純梁（スパンL）、梁Bが片持ち梁（スパンL/2）の場合等の条件による。δA:δB＝1:2。②が正答。"
    },
    {
      ...
      ans:2,
      exp:"塑性崩壊荷重Puは図中の全塑性モーメントから計算。②の200kNが正答。"
    },
    {
      ...
      ans:3,
      exp:"架構の力学的条件から③「1階柱の軸力比C:D＝3:10」が誤り。"
    },
    {
    ...
    },
    {
      ...
      ans:2,
      exp:"座屈荷重の大小関係：拘束条件と有効座屈長さから②「PA＝PC<PB」が正答。"
    },
    {
      ...
      ans:1,
      exp:"地下部分の水平震度kは深くなるほど「小さくなる」（逆）。①が不適当。"
    },
    {
      ...
      ans:4,
      exp:"速度圧は建築物の高さHの「1/2乗（平方根）」に比例ではなく、H²/³乗に比例（令87条）。実際は速度圧q＝E・q0で、EはH^(α)に比例。④が不適当。"
    },
    {
      ...
      ans:3,
      exp:"9cm角の筋かいをたすき掛けにした軸組の壁倍率は「最大5」ではなく実際の規定値と異なる。③が不適当。"
    },
    {
      ...
      ans:4,
      exp:"四分割法の壁量充足率が0.4と1.2の場合の壁率比＝0.4/1.2＝0.33<0.5なので壁率比の規定を満たさない（0.5以上が必要）。「満足する」とする④が不適当。"
    },
    {
      ...
      ans:4,
      exp:"梁の引張鉄筋比0.4%以上または必要量の4/3倍の大きい方（小さい方ではない）が必要。③が不適当。"
    },
    {
      ...
      ans:1,
      exp:"大梁上端筋のガス圧接継手は梁端部から梁せいDの1/2以上離すことが必要。「梁端部からD/2離れた位置」は条件を満たす最短距離であり、この記述自体は正しい。下端筋の重ね継手位置のずらし量は継手長の1/3以上が必要（1/2ではない）。②が不適当。なお①「D/2以上離す」は正しい規定のため①は正しい。"
    },
    {
      ...
      ans:1,
      exp:"片側スラブ付き梁の曲げ剛性計算においてスラブ効果を無視すると剛性を過小評価する。「無視して計算」は不安全側となりうるが設計上は安全側評価のため誤りとはいえない場合もあるが、「梁幅を大きくして靱性を高める」は正しい手法。①が不適当（スラブ効果無視は剛性を低く評価するため構造設計上不適当な場合がある）。"
    },
    {
      q:"鉄筋コンクリート構造に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
    ...
    },
    {
      ...
      ans:2,
      exp:"有効細長比λ＝80程度の筋かいはλ＝20程度より塑性変形能力が「低い」（中程度細長比では座屈後の耐力低下が大きい）。②が不適当。"
    },
    {
      ...
      ans:1,
      exp:"高力ボルト摩擦接合の二面せん断の長期許容せん断力は基準張力T0の値に摩擦係数・面数を乗じて算定。「T0の0.6倍」は長期許容値ではない。④が不適当。"
    },
    {
      ...
      ans:3,
      exp:"接合部の終局耐力で安全性を確認した場合でも、許容応力度による検討を省略できるかどうかは要件による。③が不適当。"
    },
    {
    ...
    },
    {
      ...
      ans:1,
      exp:"RC構造の構造設計（保有水平耐力計算等）に関する①が不適当。"
    },
    {
  ...
  "V": [
    {
      ...
      ans:2,
      exp:"クリティカルパス上の作業のフロートはゼロ。「最も大きい」は誤り。②が不適当。"
    },
    {
      ...
      ans:1,
      exp:"ボーリング調査では孔内水位観測等により地下水位の測定も可能。「測定できない」は誤り。①が不適当。"
    },
    {
    ...
    },
    {
      ...
      ans:2,
      exp:"コンクリート調合表の問題で②が不適当（図・表はPDF参照）。"
    },
    {
      ...
      ans:2,
      exp:"レディーミクストコンクリートの受入れ検査で②が不適当（表はPDF参照）。"
    },
    {
    ...
    },
    {
      ...
      ans:1,
      exp:"工事請負・監理業務委託契約（民間七会・四会）に関する①が不適当。"
    },
  ],
};