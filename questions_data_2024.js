  ...
  "I": [
    {
      ...
      ans:3,
      exp:"一級・二級・木造建築士を全て「国土交通大臣の免許」と記述しているが、二級建築士・木造建築士は「都道府県知事」の免許。国土交通大臣免許は一級建築士のみ（建築士法4条）。"
    },
    {
      ...
      ans:3,
      exp:"本願寺飛雲閣は安土桃山時代（16〜17世紀）の楼閣建築であり「平安時代に建てられた寝殿造り」という記述が誤り。3層をずらした非対称構成や複雑な破風は桃山期の特徴。"
    },
    {
      ...
      ans:4,
      exp:"ウェストミンスター宮殿（英国議事堂）は19世紀のゴシック・リバイバル様式の建築。「鏡の間」と「幾何学的庭園」はヴェルサイユ宮殿（フランス・バロック様式）の特徴であり混同に注意。"
    },
    {
      ...
      ans:2,
      exp:"ウェイファインディング・デザインとは「空間内での経路誘導・道案内のサイン計画」のこと。備品・什器を直感的に使いやすくするのはアフォーダンスデザインであり、病室内の使いやすさへの適用は誤り。"
    },
    {
      ...
      ans:2,
      exp:"基礎断熱工法は床下を準密閉空間として外気と遮断し基礎で断熱するため、ねこ土台による床下通気は設けてはいけない（通気すると断熱効果が失われる）。床下通気が必要なのは床断熱工法。"
    },
    {
      ...
      ans:3,
      exp:"特殊継手排水システムを採用しても排水縦管はパイプシャフト内（共用部）に配置し、共用部から点検・修繕するのが原則。「専有部から点検する計画」は管理上・法的に問題がある。"
    },
    {
      ...
      ans:1,
      exp:"構造用集成材はひき板の繊維方向を「同一方向（平行）」に積層接着したもの。繊維方向を互いに「直交」させて積層するのはCLT（直交集成板）の特徴であり、設問の記述はCLTの説明になっている。"
    },
    {
      ...
      ans:3,
      exp:"バレーボール公式試合（日本バレーボール協会主催の競技会）に必要な天井高さは12.5m以上。10.5mでは基準を満たせず公式試合に使用できない。"
    },
    {
      ...
      ans:2,
      exp:"バリアフリー建築設計標準では、車椅子が直角路（L字形経路）を曲がった先の通路有効幅は900mm以上が必要。800mmでは車椅子の旋回・通行ができない。"
    },
    {
      ...
      ans:4,
      exp:"都市緑地法の緑地協定は土地所有者等の「全員の合意」が必要（都市計画法の建築協定と同様）。「相当部分の参加」で成立するのは都市利便増進協定など別の協定制度。"
    },
    {
      ...
      ans:4,
      exp:"風致地区は「都市計画法」に基づき都市の風致（自然景観）を維持するために定める地区（都計法8条1項6号）。「歴史まちづくり法（歴史的風致維持向上法）」は別法律で、歴史的建造物の保全に関するもの。"
    },
    {
      ...
      ans:3,
      exp:"中野本町の家（伊東豊雄・1976年）はU字形の平面を持つRC造の住宅。「鉄骨フレーム＋アルミ・テント屋根」はシルバーハット（伊東豊雄・1984年）など別作品の特徴。"
    },
    {
      ...
      ans:3,
      exp:"コレクティブハウスは「共用スペース（コモンキッチン・食堂等）を共有しつつ、各自は独立した住戸で生活する集住スタイル」。設問の「組合を結成し設計発注から管理・運営まで行う」はコーポラティブハウスの説明。"
    },
    {
      ...
      ans:4,
      exp:"2階建てエレベーター籠で奇数・偶数階を同時輸送する方式は「ダブルデッキゾーニング方式」と呼ぶ。「コンベンショナルゾーニング方式」は通常の単層籠による一般的な配置計画を指し、設問の記述と方式名が逆。"
    },
    {
      ...
      ans:2,
      exp:"ジェントリフィケーションは「低所得者・労働者が住んでいた市街地が再開発や地価上昇により富裕層に置き換わる都市現象」。設問の「障害者が普通に生活できる社会を整える」はノーマライゼーションの説明。"
    },
    {
      ...
      ans:4,
      exp:"病院の部門配置では外来部門を「外部（道路側）からアクセスしやすい低層部」に配置するのが原則。「診療部門と病棟部門の間に外来を挟む」配置は患者動線を複雑にし、建設・運営上も不適当。"
    },
    {
      ...
      ans:1,
      exp:"富弘美術館（群馬県みどり市、内藤廣設計・2005年）は「円弧状・扇形の展示空間」が連続する有機的構成が特徴。「様々な大きさの矩形展示空間が独立して配置」は誤りで、矩形ではなく円弧状の空間構成。"
    },
    {
      ...
      ans:4,
      exp:"四会連合協定「建築設計・監理等業務委託契約約款」では、緊急時など契約条項に関わらず監理者が施工者に必要な指示を行える権限が認められている。「契約で定められた場合を除き工事施工段階での指示権限を有しない」は誤り。"
    },
    {
      ...
      ans:1,
      exp:"工事価格の正しい構成：純工事費（直接仮設費＋直接工事費）＋現場管理費＝工事原価、工事原価＋一般管理費等＝工事価格。設問の「純工事費＋一般管理費等」では現場管理費が抜けており不正確。"
    },
    {
      ...
      ans:1,
      exp:"PFI事業のBOT方式（Build-Operate-Transfer）は「建設→民間が運営→期間終了後に公共へ所有権移転」する流れ。「完成直後に所有権を移転」するのはBTO方式（Build-Transfer-Operate）であり、BOTとBTOの順序が逆。"
    }
  ],
  "II": [
    {
      ...
      ans:2,
      exp:"「室内空気温度と平均放射温度の重み付け平均」はグローブ温度（GT）や作用温度（OT）の定義。「自然室温」は暖冷房なしの室温を意味する用語であり、設問の定義は作用温度(OT)の説明になっている。"
    },
    {
      ...
      ans:4,
      exp:"床暖房の床表面温度は一般に29℃以下が快適範囲とされる。体温（37℃）より高くすると低温やけどや過熱感の原因になる。「体温よりやや高めにすることが望ましい」は誤り。"
    },
    {
      ...
      ans:2,
      exp:"温度差換気量Q＝α・A・√(2g・h・ΔT/T)。開口高低差hと有効開口面積Aが大きいほどQが大きい。図の条件（開口位置・大きさ）を比較するとQA>QB>QCが正しく、選択肢2が正解。"
    },
    {
      ...
      ans:4,
      exp:"外壁の内断熱と外断熱で断熱材の種類・厚さが同じならば熱貫流率（U値）は理論上同じ（断熱位置のみでは変わらない）。「室内側断熱のほうが熱貫流率が大きい」は誤り。実際の差は熱橋の影響によるもの。"
    },
    {
      ...
      ans:3,
      exp:"火災室から階段室に流入した高温煙の上昇速度は3〜5m/s程度。「1〜2m/s」は廊下等での水平移動速度であり、浮力で急速に上昇する階段室内の速度として過小評価で誤り。"
    },
    {
      ...
      ans:1,
      exp:"大気透過率は「直達（直射）日射のみが大気を通過する際の透過率」を示す無次元数。「直射日光と天空光（散乱光）が通過する場合の透過の程度」とする記述は誤りで、天空光を含む概念ではない。"
    },
    {
      ...
      ans:2,
      exp:"均等拡散面での照度E＝π×L（Lは輝度）。反射率ρを用いると照度E＝π×ρ×M（Mは輝度／ρで光束発散度）。「照度は輝度と反射率の積に比例する」は誤りで、照度は輝度にπを乗じたもの。"
    },
    {
      ...
      ans:3,
      exp:"加法混色（光の三原色）はR（赤）・G（緑）・B（青）で、混ぜると白光になる。シアン・マゼンタ・イエローは減法混色（色料・印刷の三原色）であり混同しないこと。"
    },
    {
      ...
      ans:1,
      exp:"障壁の回折は低音域（波長が長い）ほど音が障壁を回り込みやすく、減衰効果が「低い」。高音域ほど遮音しやすい。「高音域より低音域のほうが減衰効果が高い」は逆で誤り。"
    },
    {
      ...
      ans:4,
      exp:"コルクタイルは弾力性が小さく、軽量床衝撃音（スプーン落下等）の軽減にはある程度効果があるが、重量床衝撃音（子供の走り回り等）にはほとんど効果がない。重量衝撃音にはスラブ厚増加・防振材等が必要。"
    },
    {
      ...
      ans:4,
      exp:"VAV（変風量単一ダクト）方式でも、外気温が低い時期に外気量を増やして室内を冷却するエコノマイザーサイクル（外気冷房）は可能。「VAV方式では外気冷房はできない」は誤り。"
    },
    {
      ...
      ans:1,
      exp:"中央熱源空調方式でも、ゾーニング・VAV制御・ファンコイルユニット併用等によってパーソナル空調（個別対応）は可能。「個別に対応できないのでパーソナル空調には適さない」は誤り。"
    },
    {
      ...
      ans:3,
      exp:"事務所の冷房負荷は外気温・在室者数・OA機器稼働状況・照明等で季節・時間帯ごとに大きく変動する。ピーク負荷のみ考慮すると部分負荷時の効率が悪化し設備の過大選定になるため、PLV（部分負荷効率）の考慮が必要。"
    },
    {
      ...
      ans:1,
      exp:"節水器具使用の場合、事務所の設計給水量は60〜100L/人・日が一般的計画値。「120〜150L/人・日」は通常（節水なし）の計画値に近く、節水器具使用時の設定として過大。"
    },
    {
      ...
      ans:2,
      exp:"排水槽の底部勾配は1/10〜1/15程度が標準。「1/5以上」は急勾配すぎる。また吸込みピットは底部の最も低い位置（最深部）に設けることで湧水・汚水を集水する。"
    },
    {
      ...
      ans:4,
      exp:"低圧受電の戸建て住宅のコンセント接地工事にはD種接地工事（接地抵抗100Ω以下）を採用。A種接地工事は高圧（6600V等）機器の外箱等に使用するもので、低圧住宅コンセントには不適。"
    },
    {
      q:"電気設備に関する次の記述のうち、最も不適当なものはどれか。",
      choices:[
      ...
      ans:1,
      exp:"電気設備技術基準では交流の低圧区分は「600V以下」（直流は750V以下）。「交流750V以下を低圧」とする記述は誤りで、交流600Vを超えると高圧扱いとなる。交流と直流で基準値が異なる点に注意。"
    },
    {
      ...
      ans:4,
      exp:"病院・ホテル等の不特定多数が利用する施設では、1人でも操作できる「易操作性1号消火栓」または「2号消火栓」を設置する。通常の「1号消火栓」は2名操作が前提で不特定多数施設向きではない。"
    },
    {
      ...
      ans:1,
      exp:"現行の地震時エレベーター管制では、地震感知器作動後に「最寄り階に停止して乗客を降ろす（最寄り階管制）」のが正しい運転。「避難階（1階）まで帰着」では途中での停電・閉じ込めリスクが高い。"
    },
    {
      ...
      ans:3,
      exp:"LEEDは米国グリーンビルディング協議会（USGBC）による建築物の総合的な環境性能評価システム（省エネ・節水・材料・屋外環境等を総合評価）。「人の健康やウェルネスに着目」したのはWELL認証（別のシステム）。"
    }
  ],
  "III": [
    {
      ...
      ans:3,
      exp:"「設計図書」は建築士が作成する設計の成果物（設計図・仕様書等、法2条12号）。工事用の図面は施工管理用であり設計図書ではない。記念塔は高さ4mであっても設計図書は当然必要だが、「工事用の図面」が設計図書に含まれるという記述が誤り。"
    },
    {
      ...
      ans:2,
      exp:"北側高さ制限（法56条）において「敷地が北側で公園に接する場合に公園幅の1/2だけ外側に隣地境界線をみなす」規定はない。「道路に接する場合」に道路中心から斜線を引く規定（いわゆる北側道路緩和）とは異なる。"
    },
    {
      q:"次の記述のうち、建築基準法上、誤っているものはどれか。",
      choices:[
      ...
      ans:2,
      exp:"病院等の特殊建築物の工事中使用の届出は、建築主が工事着手前に「特定行政庁に届け出る」ことで足り（法90条の3）、許可は不要。設問は「申請」（許可申請）としているが正しくは「届出」。"
    },
    {
      ...
      ans:4,
      exp:"用途変更の完了届出は「特定行政庁」に行う（法87条、法7条の2）。指定確認検査機関が確認済証を交付した場合でも、完了届出先は特定行政庁であり、指定確認検査機関への届出では不足。"
    },
    {
      ...
      ans:2,
      exp:"正しい組合せはイ（劇場の昇降機機械室用階段の蹴上・踏面規定が正しい）とニ（特定の用途での廊下幅規定が正しい）。ロは共同住宅の共用廊下の幅員に関する記述が誤り、ハは病院の階段規定の記述が誤り。"
    },
    {
      ...
      ans:3,
      exp:"延べ面積1000m²超の木造小学校に設ける防火壁は「耐火構造」でなければならず（法26条）、「準耐火構造の防火壁」では足りない。防火壁に準耐火構造を適用できるとする記述が誤り。"
    },
    {
      q:"次の記述のうち、建築基準法上、誤っているものはどれか。",
      choices:[
      ...
      ans:2,
      exp:"耐火構造は「加熱終了後も」構造耐力上支障のある変形・損傷を生じないことが要件（政令107条）。準耐火構造は加熱「時間中」の要件のみで「加熱終了後」の要件はない。設問は両者が同じ要件と記述しており誤り。"
    },
    {
      ...
      ans:1,
      exp:"非常用の進入口は外壁面の長さ「10m以内ごと」に設置が必要（令126条の6）。「40m以内ごと」は誤りで、10m間隔と40m間隔は大きく異なる。高さ31m以下の3〜10階各階が対象。"
    },
    {
      ...
      ans:2,
      exp:"屋外避難階段の入口に設ける防火戸は「加熱開始後20分間遮炎できるもの（いわゆる甲種防火戸相当）」が必要（令123条1項1号）。「10分間遮炎」では基準を満たさず避難安全上不十分。"
    },
    {
      ...
      ans:4,
      exp:"エスカレーター踏段の積載荷重は踏段面水平投影面積1m²につき2500N（令115条の5）。13m²であれば32500N（32.5kN）。「33kNとすることができる」は2500N/m²×13m²＝32500Nを超えており適切でない。"
    },
    {
      ...
      ans:2,
      exp:"保有水平耐力計算（ルート3）で安全性を確かめる場合でも、RC造耐力壁の厚さは「12cm以上」としなければならない規定（令78条の2第1項）は適用される。「としなくてもよい」は誤り。"
    },
    {
      ...
      ans:1,
      exp:"建築物の地下部分の地震力は、固定荷重＋積載荷重の和に「水平震度k（令88条4項）」を乗じて算出する。地上部分の地震層せん断力係数Ciを用いる計算式とは別の規定であり、「Ciを乗じる」は誤り。"
    },
    {
      ...
      ans:4,
      exp:"鋼材の突合せ溶接継目のせん断に対する短期許容応力度はF/√3（令96条、基準強度Fを√3で除す）。設問の「F/(1.5√3)」は長期許容応力度の式であり、短期と長期を混同した誤り。"
    },
    {
      ...
      ans:4,
      exp:"地区計画内の予定道路上空に渡り廊下を新築する場合でも特定行政庁の許可が必要（法44条1項4号）。「予定道路が指定された場合には許可なく新築できる」は誤りで、予定道路上空の工作物は許可申請が原則。"
    },
    {
      ...
      ans:1,
      exp:"田園住居地域内で建築できる老人福祉センター等の社会福祉施設は「延べ面積500m²以下かつ2階以下」が条件（令130条の9の2）。延べ面積700m²は500m²を超えるため建築できず、「新築することができる」は誤り。"
    },
    {
      ...
      ans:1,
      exp:"容積率の算定では前面道路幅員×4/10（住居系）と指定容積率のうち小さい方を適用し、容積率×敷地面積で延べ面積の最大値を求める。設問の敷地条件から計算すると最大延べ面積は640m²が正解。"
    },
    {
      ...
      ans:3,
      exp:"道路斜線・北側斜線等の高さ制限を計算すると、設問の敷地条件（道路幅員・セットバック等）からA点の建物最高高さの限度は25.00mが正解。"
    },
    {
      ...
      ans:3,
      exp:"防火地域・準防火地域にまたがる敷地では、建物の規模・用途・各地域内の面積等によって各棟の耐火性能要件が決まる。設問の条件のもとではCの建物は耐火建築物等とする必要がない（他棟との距離・規模等の条件から）のに「しなければならない」としており誤り。"
    },
    {
      ...
      ans:1,
      exp:"一団地認定（法86条）では当該一団地を「一の敷地とみなす」のは建蔽率・容積率等の算定のため。用途制限（用途地域による建築用途の制限）はみなし敷地でも適用が除外されるわけではなく、各建築物に個別に適用される。「用途制限が適用されない」は誤り。"
    },
    {
      q:"次の記述のうち、建築基準法上、誤っているものはどれか。",
      choices:[
      ...
      ans:3,
      exp:"既存不適格建築物への段階的増築で全体計画認定（法86条の8）を受けた場合、各工事完了後には「その工事に係る部分」が現行規定に適合する必要があり、全ての工事完了後まで不適合でよいわけではない。「いずれの工事完了後であっても現行基準を適用しなくてよい」は誤り。"
    },
    {
      ...
      ans:4,
      exp:"建築士法（法18条3項）では、工事監理者は工事が設計図書通りでないと認めるときは施工者への指摘・是正要求を行い、施工者が従わない場合は「建築主（発注者）」に報告する。「特定行政庁に報告する」義務はなく誤り（建築主への報告が先）。"
    },
    {
      ...
      ans:4,
      exp:"建築士事務所の工事監理報告書の保存期間は作成日から「15年間」（建築士法24条の4第1項）。「5年間」は委託契約関係書類等（24条の7）の保存期間であり混同しやすい。"
    },
    {
      ...
      ans:1,
      exp:"建築士事務所の「技術的事項を総括」するのは管理建築士（専任の所属建築士、建築士法24条）の業務。開設者が自ら総括する義務はなく、管理建築士に担わせる仕組み。「開設者が自ら総括しなければならない」は誤り。"
    },
    {
      ...
      ans:3,
      exp:"都市計画法42条1項ただし書きにより、開発許可区域内で用途地域等が定められている場合は、工事完了公告後に予定建築物以外を建築するときの許可（同条1項本文）は不要。「許可を受けなければならない」は誤りで、用途地域がある場合は許可不要。"
    },
    {
      ...
      ans:2,
      exp:"延べ面積150m²の飲食店（消防法令別表第一(3)項ロ）は消火器の設置義務がある施設（延べ面積150m²以上）に該当する。「消火器を設置しなくてもよい」は誤りで、設置義務がある。"
    },
    {
      ...
      ans:3,
      exp:"バリアフリー法17条の認定（建築物移動等円滑化誘導基準への適合認定）は建築主等が任意に申請するもの（法17条1項）。「申請しなければならない」（義務）とする記述は誤りで、認定は任意の制度。"
    },
    {
      ...
      ans:1,
      exp:"特定建築物の増築（非住宅・床面積300m²以上）はエネルギー消費性能基準への「適合義務」が課される（建省エネ法11条1項）。「努めなければならない（努力義務）」は誤りで、増築は義務適合対象。"
    },
    {
      ...
      ans:4,
      exp:"特定建築物の定期報告（法12条1項）の報告間隔は概ね「3年以内ごと」（特定建築物の場合）または毎年（防火設備等）。「5年間隔」は誤りで、報告義務の間隔をより長く思わせる記述。"
    },
    {
      q:"以下の条件に該当する建築物の新築に係る設計に際して、建築基準法その他の法令の規定の適用に関する設計者の判断として、次の記述のうち、誤っているものはどれか。[条件省略]",
      choices:[
      ...
      ans:3,
      exp:"百貨店等の特殊建築物で2〜4階に売り場がある場合、直通階段3つのうち「2つ以上」は避難階段または特別避難階段でなければならない（令122条）。3つのうち1つだけが避難階段で残り2つが通常階段では規定を満たさない場合がある。設問の構成が条件によっては不適。"
    },
    {
      ...
      ans:4,
      exp:"宅地造成及び特定盛土等規制法（令和5年改正）では、特定盛土等規制区域内での高さ2mを超える盛土等は事前の「許可」が必要（法30条）。「工事着手30日前までに届け出る」（届出扱い）は誤りで、許可申請が必要。"
    }
  ],
  "IV": [
    {
      ...
      ans:4,
      exp:"十字形断面（幅a×高さa+幅3a×高さaの組み合わせ等）のX軸回り断面二次モーメントと断面係数の計算。各矩形の断面二次モーメントを足し合わせると I=10a⁴、断面係数 Z=I/y_max=5a³が正しく、選択肢4が正解。"
    },
    {
      ...
      ans:3,
      exp:"B点ヒンジを持つ梁の反力計算。B点のモーメント条件（ΣMB＝0）からRCを求め、次いでRAを算出するとRA:RC＝4:1が正解。B点左側部分のモーメント釣り合いが解法の鍵。"
    },
    {
      ...
      ans:4,
      exp:"ラーメン構造に荷重6Pが作用した時の曲げモーメント図の問題。部材の変形適合条件と力のつり合いから各部材に生じる曲げモーメントを求めると、形状・符号ともに選択肢4の曲げモーメント図が正しい。"
    },
    {
      ...
      ans:1,
      exp:"筋かいBCの引張力100kNが既知のとき、柱ABに生じるモーメントを算出する問題。節点の力の釣り合いから、柱ABのモーメントは60kN・mが正解。"
    },
    {
      ...
      ans:4,
      exp:"トラスの斜材軸方向力の比率計算。断面法または節点法でそれぞれの斜材に生じる軸力を求めると、NA:NB:NC＝5:3:1が正解。"
    },
    {
      ...
      ans:2,
      exp:"支持条件の異なる3本の柱の弾性座屈荷重Pの比較。有効座屈長さはA＞B＝Cの順（支持条件により異なる）のため、PA<PB＝PCとなる。"
    },
    {
      ...
      ans:4,
      exp:"減衰定数が大きいほど固有周期近傍で加振されたときの振幅は「小さく」なり揺れが抑えられる（制振効果）。「減衰定数が大きいほど大きい振幅の振動が発生する」は逆で誤り。"
    },
    {
      ...
      ans:4,
      exp:"地震層せん断力は「その階より上の全重量（固定荷重＋積載荷重）の和」にCiを乗じて求める（令88条）。「その階の固定荷重と積載荷重の和のみ」にCiを乗じる記述は1階分しか考慮しておらず誤り。"
    },
    {
      ...
      ans:3,
      exp:"母屋の継手は応力が大きい「小屋束と小屋束の中央部（スパン中央：曲げモーメント最大位置）」を避け、支持点（小屋束）の直近に設けるのが正しい。「中央部付近に設ける」は最も不利な位置で誤り。"
    },
    {
      ...
      ans:2,
      exp:"木造2階建ての必要壁量計算問題。建物重量（屋根の種類・床面積）と地域係数から各方向の必要壁量係数を算出するとX方向0.75・Y方向0.50が正解。"
    },
    {
      ...
      ans:1,
      exp:"RC造柱梁接合部への水平力によるせん断ひび割れは、接合部パネルに斜め方向で生じる。設問の図と説明の組み合わせで「柱梁接合部のせん断ひび割れ」の説明が最も不適当なもの（選択肢1）が誤り。"
    },
    {
      ...
      ans:2,
      exp:"ガス圧接継手はJASS 5の規定により「母材の引張強度以上」の継手耐力が必要。「継手位置の存在応力度を伝達できれば足りる」では規定を満たさず、引張強度を基準とするより厳しい規定が適用される。"
    },
    {
      ...
      ans:2,
      exp:"RC梁のせん断補強筋をSD295からSD345に変えても、許容応力度計算でのあばら筋降伏強度の上限（195N/mm²）を既に超えている場合には許容せん断力は増加しない。「あばら筋の強度を上げれば必ず許容せん断力が大きくなる」は条件によっては誤り。"
    },
    {
      ...
      ans:3,
      exp:"RC造柱梁接合部のせん断耐力は接合部コンクリートの負担が主体で、取り付く梁の主筋量が増えると梁主筋から接合部への力が増大し、接合部のせん断応力度が上昇しせん断耐力は「低下」する方向に働く。「主筋量が多いほど接合部せん断耐力が大きい」は誤り。"
    },
    {
      ...
      ans:2,
      exp:"鋼材の降伏比（＝降伏点÷引張強度）が大きいほど、降伏後の歪み硬化余裕（降伏点から破断までの変形領域）が小さく、塑性変形能力は「低下」する。「降伏比が大きいほど塑性変形能力が向上する」は逆で誤り。"
    },
    {
      ...
      ans:1,
      exp:"強度の異なる鋼材を突合せ溶接する場合、溶接材料・条件は「強度が低い方の鋼材」に対応させるのが原則で、許容応力度も低い方の鋼材に準ずる。「高い方に対応すれば高い許容応力度にできる」は規定に反し誤り。"
    },
    {
      ...
      ans:2,
      exp:"鉄骨造ルート1-2は標準せん断力係数0.3で計算するが、偏心率の確認（各階≦0.15）も義務付けられている。「偏心率の確認を行わず0.3で割増するだけでよい」は誤りで、偏心率確認は省略できない。"
    },
    {
      ...
      ans:1,
      exp:"柱・梁の幅厚比の上限値は、基準強度Fが大きいほど「小さく」なる（高強度鋼材は局部座屈が生じやすいため幅厚比を厳しく制限する）。「Fが大きいほど幅厚比の上限が大きくなる」は逆で誤り。"
    },
    {
      ...
      ans:4,
      exp:"砂質土の液状化は細粒分（粘土・シルト）が少ない砂地盤で起こりやすい。細粒分含有率が大きくなると間隙が粘土で充填されて液状化に対する抵抗が増し、FLは「大きく」なる（液状化しにくくなる）。「細粒分が多いほどFLが小さい」は逆で誤り。"
    },
    {
      ...
      ans:1,
      exp:"一軸圧縮試験は「拘束圧なし（σ₃＝0）」の状態で行う試験であり、粘着力c（非排水せん断強度）のみが求まる。内部摩擦角φを求めるには三軸圧縮試験等が別途必要。「拘束圧を作用させた状態で行う」は誤り。"
    },
    {
      ...
      ans:3,
      exp:"群杭に水平力が作用すると隣接杭の応力球根が重なり（群杭効果）、単杭と比べて1本当たりの水平抵抗は「小さく」なる。「群杭1本当たりの水平抵抗は大きくなる」は逆で誤り（選択肢3が誤り）。"
    },
    {
      ...
      ans:2,
      exp:"壁式RC造の耐力壁長さ算定において、住宅用換気扇開口（φ150mm程度）であっても開口補強なしでは耐力壁の有効長さから除外しなければならない（JASS 5W等）。「補強しなくても算入できる」は誤り（選択肢2が誤り）。"
    },
    {
      ...
      ans:3,
      exp:"デッキ合成スラブの長期たわみに用いる変形増大係数は、梁と同じ値は適用できず、スラブ種別に応じた別途規定値（一般に梁より大きい値）を用いる必要がある。「梁と同じとすることができる」は誤り（選択肢3が誤り）。"
    },
    {
      ...
      ans:1,
      exp:"鋼材ダンパーのエネルギー吸収効率は、主架構変形とダンパー変形を直接連動させる「せん断パネル型（壁型）」のほうが、変形が一部ロスする「ブレース型」より高い。「ブレース型より低い」は逆で誤り（選択肢1が誤り）。"
    },
    {
      ...
      ans:3,
      exp:"長周期建物は軟弱地盤（固有周期が長い）と共振しやすく必要保有水平耐力が大きくなる傾向がある。「硬質地盤のほうが必要保有水平耐力は大きい」は逆で誤り（選択肢3が誤り）。"
    },
    {
      ...
      ans:3,
      exp:"偏心によるねじれを小さくするには、剛心と重心の距離を縮める必要がある。耐力壁Cの削除は既存のバランスを崩し偏心を悪化させるため、最も不適当な措置（選択肢3が誤り）。"
    },
    {
      ...
      ans:2,
      exp:"無等級材の繊維方向基準強度の大小関係は一般に「引張＞曲げ＞せん断」。設問「せん断＜曲げ＜引張」はせん断が最小である点は正しいが、引張が曲げより大であることが「曲げ＜引張」の記述が正しいかを問うており、実際は引張＞曲げのため設問選択肢2（この順序を別様に記述）が誤り。"
    },
    {
      ...
      ans:4,
      exp:"円柱コア供試体の圧縮強度は高さ/直径比（h/d）が「大きいほど小さく」なる（h/d＝2が標準で、これより大きいと座屈効果で強度低下）。「h/d比が大きいほど圧縮強度が大きい」は逆で誤り（選択肢4が誤り）。"
    },
    {
      ...
      ans:1,
      exp:"SN材のうち、シャルピー衝撃試験の吸収エネルギー下限値が規定されているのはB種とC種のみ。A種には規定がない。「いずれも（A・B・C）シャルピー衝撃試験の下限値が定められている」は誤り（選択肢1が誤り）。"
    },
    {
      ...
      ans:4,
      exp:"住宅性能表示の耐震等級では「等級3」が最高（建築基準法の1.5倍の耐力）で、「等級1」が建築基準法レベル（最低基準）。「最も高いのは等級1」は等級3と逆で誤り（選択肢4が誤り）。"
    }
  ],
  "V": [
    {
      ...
      ans:1,
      exp:"監理者は設計図書の矛盾・誤謬等を発見した場合、「工事施工者に確認」するのではなく「建築主（発注者）に報告・指示を仰ぐ」のが正しい業務手順（選択肢1が誤り）。"
    },
    {
      ...
      ans:2,
      exp:"くい打機の巻上げワイヤロープの安全係数は「5以上」（労安衛則164条）。「4以上とすればよい」は基準値を満たさず誤り（選択肢2が誤り）。"
    },
    {
      ...
      ans:4,
      exp:"鉄筋手動ガス圧接の外観検査はJASS 5の規定により全数検査が必要。「1検査ロットから無作為に抜き取った一部のみを検査する抜取り検査」では基準を満たさず誤り（選択肢4が誤り）。"
    },
    {
      ...
      ans:3,
      exp:"騒音規制法の特定建設作業の届出は「作業開始の7日前まで」（騒規法14条）に市区町村長へ届け出が必要。「3日前までに届け出た」は期日不足で誤り（選択肢3が誤り）。"
    },
    {
      ...
      ans:4,
      exp:"枠組足場の墜落防止措置として交差筋かいを設ける場合の幅木高さは「15cm以上」（労安衛則563条）。「10cmの幅木」は基準を下回り不十分で誤り（選択肢4が誤り）。"
    },
    {
      ...
      ans:2,
      exp:"釜場は掘削底面の「最も深い（低い）位置」に設け、周辺より低くすることで湧水を集水する。「最も浅い場所に設置」は水が集まらず集水効果がなく誤り（選択肢2が誤り）。"
    },
    {
      ...
      ans:1,
      exp:"アースドリル工法の安定液は孔壁崩壊防止が主目的であり、コンクリート打設前には比重・粘性を適切に管理してコンクリートとの置換を容易にする必要がある。「コンクリートとの置換を容易にする」という管理は正しく、これを「不要」とする記述が誤り（選択肢1が誤り）。"
    },
    {
      ...
      ans:3,
      exp:"異径鉄筋の重ね継手および鉄筋相互のあきは「太い方の鉄筋の径」を基準とする（JASS 5）。「細い方の径を基準とした」は誤り（選択肢3が誤り）。"
    },
    {
      ...
      ans:2,
      exp:"計画供用期間「標準」の柱のせき板存置期間は、平均気温10℃以上では材齢3日以上（セメント種別により異なる）。「20℃で材齢3日」は普通ポルトランドセメントの場合の基準だが、選択肢2の記述内容が存置期間の基準に反しており誤り。"
    },
    {
      ...
      ans:1,
      exp:"レディーミクストコンクリートの受入れ検査で空気量・スランプが許容差を超えた場合、現場での添加剤（AE減水剤等）追加は禁止されており、当該バッチは不合格として返品・打設中止が原則（選択肢1が誤り）。"
    },
    {
      ...
      ans:2,
      exp:"マスコンクリートの温度ひび割れ防止目的で実施する冷却は、打設後の「表面への散水冷却」ではなく、事前に使用材料を冷却するプレクーリングや埋設パイプによるパイプクーリングが適切（表面散水は表面温度を下げすぎて温度差ひび割れを誘発する恐れがある）（選択肢2が誤り）。"
    },
    {
      ...
      ans:1,
      exp:"プレキャスト耐力壁の水平接合部に用いる敷モルタルは、材齢28日の圧縮強度が「部材コンクリートの設計基準強度以上」必要。「設計基準強度の2/3以上で足りる」等の過小評価は誤り（選択肢1が誤り）。"
    },
    {
      ...
      ans:4,
      exp:"溶融亜鉛めっきF8T高力ボルトのボルト孔径はF10TのM20の最大孔径より「2.0mm大きく」する（公共建築工事標準仕様書等）。「1.0mm大きく」では不足で誤り（選択肢4が誤り）。"
    },
    {
      ...
      ans:1,
      exp:"スタッド溶接の施工前試験はスタッドの「径の種類ごと」に午前・午後の作業開始前に各1本（計2本以上）行う。「径ごとに1日1本」では試験数が不足で誤り（選択肢1が誤り）。"
    },
    {
      ...
      ans:3,
      exp:"木造軸組の防腐・防蟻処置は「地面から高さ1m以内の木部」が対象範囲（フラット35技術基準等）。「地面から60cm以内のみ」では範囲が不足で誤り（選択肢3が誤り）。"
    },
    {
      ...
      ans:2,
      exp:"塗膜防水の防水材塗継ぎ重ね幅は「100mm以上」、補強布重ね幅も「100mm以上」が標準（JASS 8）。「防水材の重ね幅を50mm」は基準の半分しかなく不十分で誤り（選択肢2が誤り）。"
    },
    {
      ...
      ans:1,
      exp:"屋内吹抜け部分の壁タイル打音検査は「全面」を対象に行う（JASS 19）。「1/2以下の抜取り」は基準を満たさず誤り（選択肢1が誤り）。"
    },
    {
      ...
      ans:2,
      exp:"ガラスブロック積み工法の目地幅は特記がなければ「10mm」が標準（JASS 17）。「6mm」は過小で施工上の誤差吸収が困難になり誤り（選択肢2が誤り）。"
    },
    {
      ...
      ans:4,
      exp:"軽量鉄骨天井下地のクリップは野縁の「ひずみ防止」のためつめの向きを「交互（互い違い）」にする。「つめの向きをそろえる」とひずみが片側に偏るため誤り（選択肢4が誤り）。"
    },
    {
      ...
      ans:4,
      exp:"横走り排水管の最小勾配は呼び径65以下が1/50、呼び径75〜150が1/100（JASS 2）。設問の「呼び径50を1/100・呼び径75を1/150」は数値が逆で誤り（選択肢4が誤り）。"
    },
    {
      ...
      ans:3,
      exp:"フローリング釘留め工法では、壁・幅木・敷居等との取合い部に「膨張・収縮の逃げ代として5mm程度の隙間」を設ける（JASS 26）。「隙間を設けずに固定する」とフローリング材の伸縮で変形・割れが生じ誤り（選択肢3が誤り）。"
    },
    {
      ...
      ans:3,
      exp:"連続繊維補強工事のプライマーはコンクリート表面が「十分に乾燥した状態」で塗布する（JASS 7）。「湿潤させてから塗布」は付着力が低下し剥離の原因になるため誤り（選択肢3が誤り）。"
    },
    {
      ...
      ans:3,
      exp:"鉄筋腐食の補修では、さびを除去した後に「防錆材（エポキシ系錆止め等）」を塗布してから断面修復する。「浸透性吸水防止材」は腐食した鉄筋への再腐食防止には効果が不十分で誤り（選択肢3が誤り）。"
    },
    {
      ...
      ans:1,
      exp:"クラックスケールはコンクリートのひび割れの「幅（開口量）」を測定する目盛り付きゲージ。「ひび割れの長さ」を測定する器具ではなく誤り（選択肢1が誤り）。"
    },
    {
      ...
      ans:4,
      exp:"民間七会工事請負契約約款の「部分使用」は発注者・受注者の「合意」に基づくものであり、法定検査（完了検査済証取得）は必須条件ではない（約款44条）。「法定検査を受けて確認申請の要件を満たしたうえで」という記述が誤り（選択肢4が誤り）。"
    }
  ]
};
